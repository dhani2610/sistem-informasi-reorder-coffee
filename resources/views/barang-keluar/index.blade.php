                    ...
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <form role="form text-left" method="POST" action="{{ route('tambah-barang-keluar') }}" enctype="multipart/form-data">
                                    @csrf
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('delete-barang-keluar',$item->id) }}" type="button" >
...
@foreach ($barang_keluar as $item2)
<div class="modal fade" id="modaledit{{ $item2->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <form role="form text-left" method="POST" action="{{ route('update-barang-keluar',$item2->id) }}" enctype="multipart/form-data">
            @csrf
            <div class="modal-body">
                    @csrf
                <div class="mb-3">
